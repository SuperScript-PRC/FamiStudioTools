...
def generate_fds_instrument(
    ...
    return Property(
        ...
        "Instrument",
        {
            ...
            "Expansion": "FDS",
            "FdsWaveCount": str(WAVE_COUNT),
            "FdsWavePreset": "Custom",
            "FdsModPreset": "Flat",
            "Folder": folder_name,
        },
        children=[
            ...
            Property(
                2,
                "Envelope",
                {"Type": "FDSMod", "Length": "32", "Values": ",".join("1" * 32)},
                children=[],
            ),
            Property(
                2,
                "Envelope",
                {"Type": "Repeat", "Length": "16", "Values": ",".join("1" * 16)},
                children=[],
            ),
        ],
    )
...
def collect_waves(
    ...
    for w in ws:
        ...
        instrument = generate_fds_instrument(
            instrument_name, folder_name, w
        )
